...
<h3>Field Electric</h3>
<div style="display: flex; gap: 16px;">
  <img src="../../assets/images/field/field_electric.png" alt="Field Electric 7" style="height:220px;">
  <img src="../../assets/images/field/field_electric_synergies.png" alt="Synergies" style="height:220px;">
</div>
<h3>Field Electric Wild</h3>
<div style="display: flex; gap: 16px;">
  <img src="../../assets/images/field/field_electric_5_wild_4.png" alt="Field Electric 5 Wild 4" style="height:220px;">
...
<ul>
  ...
  <li>Its usually better to play something else early and pivot into field if the adds are good.</li>
  <li>The early add picks are very important.</li>
  <li>There are 5 normal add picks. They are Skitty (uncommon), Minccino (uncommon), Meowth (rare), Sentret (rare), and Girafarig (epic). With at least 3 + hitting a field/normal unique you can hit Field 9 Normal 7. If you hit 3 in uncommon/rare, try to get a field/normal unique.</li>
...
<h3>Uniques</h3>
<ul>
  <li>Backup portals are Normal (1/5), Fire (1/6), Wild (1/8), Electric (1/13), Psychic (1/15). Delibird is not good enough to go for.</li>
  <li>Its hard to make more than 1 field portal so usually you don't get a choice.</li>
  <li>Plusle/Minun are the high roll, especially if Electrike is in. They can be itemized as casters.</li>
  <li>Stantler is always good. It evolves on t20 into a good lategame carry and gives Wild 2 with 3/4 Legendaries and is a good reason to also look for Zigzagoon and Espurr.</li>
  <li>Heatmor is kind of mediocre but with Growlithe you can stay open to Fire 6 or 8.</li>
  <li>If you have at least 3/4 of the Normal add picks its good to aim for one of the Field/Normal uniques. In terms of stats Furfrou > Tauros > Milktank. However Milktank can open up interesting Gourmet angles if Fidough is in</li>
...
<ul>
  ...
  <li>Usually its best to run all field units, unless you are splashing a powerful synergy like Gourmet.</li>
  <li>Once you see the epic add picks its time to evaluate if its worthwhile to go for Electric/Fire/Psychic.</li>
  <li>If you hit Plusle/Minun or Electrike is in with Thunderstone you can go Electric 5. If both are in you can go Electric 7 with Thunderstone. Always play Electric if possible.</li>
  <li>For Fire, you always have Cyndaquil and Litten. If you have all of Growlithe add, Ponyta add, Heatmor unique, and Numel region you can always make Fire 6. And Entei + Firestone gets Fire 8. In this case it may be worthwhile to run more Fire Pokemon over Field to start generating shards.</li>
  <li>Only consider Psychic with Stantler unique. Espurr is always in but is annoying to get. It is worth running with Stantler alone. If you have 2 of Munna add, Girafarig add, and Spoink region go for Psychic 4. If you have all 3 try to get a Dawnstone and put it on your legendary.</li>
  <li>Usually you want to itemize your unique and let it carry you.</li>
...
<h3>Late Game</h3>
<ul>
  <li>The lategame is pretty simple. You always need to get to Field 9. Try to greedy level as much as possible.</li>
...
<ul>
  <li>There are 5 Normal add picks. They are Skitty (uncommon), Minccino (uncommon), Meowth (rare), Sentret (rare), and Girafarig (epic).</li>
  <li>With at least 3 + hitting a Field/Normal unique you can hit Field 9 Normal 7. If you hit 3 in uncommon/rare, try to get a Field/Normal unique.</li>
  <li>Always play as many Field/Normal units as possible in a box, with the ranged units in the center.</li>
...
<ul>
  ...
  <li>You always have Cyndaquil and Litten. If you have all of Growlithe add, Ponyta add, Heatmor unique, and Numel region you can always make Fire 6. And Entei + Firestone gets Fire 8.</li>
  <li>If you are close to Fire 8 and have enough health, just put some not Field Pokemon in to get Fire Shards for your carry.</li>
  <li>Camerupt region is very important to hit.</li>
  <li>There are 8 Field/Fire Pokemon:
    <ul>
      <li><b>Cyndaquil</b> - Uncommon. Pretty decent early ranged unit. If you are in a Ghost region in the midgame could consider Typhlosion.</li>
      <li><b>Growlithe</b> - Uncommon add pick. Pretty decent unit. Regional form is stronger but wants Protective Pads. Very good if you start in Rock region, since you can get both after midgame. Probably worth rollings some to finish Hisuian Arcanine in early game.</li>
      <li><b>Litten</b> - Epic. Decent but kind of understatted. Ability scales with attack and attack speed. Dark type is kind of a detriment.</li>
...
<h3>Electric 7</h3>
<div style="display: flex; gap: 16px;">
  <img src="../../assets/images/field/field_electric.png" alt="Electric 7" style="height:220px;">
  <img src="../../assets/images/field/field_electric_synergies.png" alt="Synergies" style="height:220px;">
</div>
<h3>Electric 5 Wild 4</h3>
<div style="display: flex; gap: 16px;">
  <img src="../../assets/images/field/field_electric_5_wild_4.png" alt="Electric 5 Wild 4" style="height:220px;">
  <img src="../../assets/images/field/field_electric_5_wild_4_synergies.png" alt="Synergies" style="height:220px;">
</div>
<ul>
  <li>The only Electric add pick is Electrike (uncommon). It is a huge signal to play Field.</li>
  <li>The only other conditional is if you hit Plusle/Minun and Raikou. If either of these things happen you should try to play Electric 3 or 5.</li>
  <li>Electric 7 is possible if you hit everything and have 1 Thunderstone. This is worth doing, because adding Electric to a Pokemon is better than most items, but the Electric 7 boost is very minor.</li>
  <li>Mareep and Shinx should be played in all games to get on Light 2. Put your Legendary or strongest carry in the light spot.</li>
  <li>There are 5 Field/Electric Pokemon:
    <ul>
...
<ul>
  ...
  <li>Always pick up Espurr if possible. It is incredible with Stantler, but is also worth playing if you hit a wild legendary (3/4).</li>
  <li>After you hit Stantler and see epic add picks, evaluate how many Psychics are in. If there are 4, its usually worthwhile to go for Psychic 4. If all 5 are in try to make a Dawnstone and put it on your legendary for Psychic 6.</li>
  <li>Keep an eye out for useful unknowns to play in PvE rounds.</li>
  <li>There are 5 Field/Psychic Pokemon:
    <ul>
