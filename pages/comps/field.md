...
# <img src="../../assets/images/types/field.svg" alt="Field" style="height:60px;"> Field Synergy Guide <img src="../../assets/images/types/field.svg" alt="Field" style="height:60px;">
...
<ul>
  ...
  <summary>Shiny Item Tier List</summary>
    <ul>
      <li><img src="../../assets/images/items/shiny_stone.png" alt="Shiny Stone" style="height:25px;"><b> Shiny Stone</b> - Incredible since you will always be on <img src="../../assets/images/types/light.svg" alt="Light" style="height:25px;"> in the endgame. Also condsider just pivoting into light.</li>
...
<h3>Late Game</h3>
<ul>
  <li>The lategame is pretty simple. You always need to get to <img src="../../assets/images/types/field.svg" alt="Field" style="height:25px;"> 9. Try to greedy level as much as possible.</li>
  <li>Its usually better to fully itemize a few strong carries with DPS and sustain.</li>
  <li>Watch for opponents that want specific items to counter them, like <img src="../../assets/images/types/rock.svg" alt="Rock" style="height:25px;"> Rocky Helmet, Assault Vest, or Fluffy Tail.</li>
</ul>
</details>
  ...
  <li>There are 8 <img src="../../assets/images/types/field.svg" alt="Field" style="height:25px;">/<img src=../../assets/images/types/FIRE.svg alt="Fire" style="height:25px;"> Pokemon:
    <ul>
      ...
      <li><b>Growlithe</b> - Uncommon add pick. Pretty decent unit. Regional form is stronger but wants Protective Pads. Very good if you start in <img src="../../assets/images/types/rock.svg" alt="Rock" style="height:25px;"> region, since you can get both after midgame. Probably worth rollings some to finish Hisuian Arcanine in early game.</li>
            <li><b>Litten</b> - Epic. Decent but kind of understatted. Ability scales with attack and attack speed. <img src="../../assets/images/types/dark.svg" alt="Dark" style="height:25px;"> type is kind of a detriment.</li>
